...
include('../dbConnection.php');
 ...
 if(isset($_SESSION['tea_is_login'])){
  $adminEmail = $_SESSION['teaLogEmail'];
 } else {
 ...
 if(isset($_REQUEST['requpdate'])){
  ...
  if(($_REQUEST['lesson_id'] == "")||($_REQUEST['tea_id'] =="") || ($_REQUEST['lesson_name'] == "") || ($_REQUEST['lesson_desc'] == "") || ($_REQUEST['course_id'] == "") || ($_REQUEST['course_name'] == "")){
   // msg displayed if required field missing
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
  } else {
    // Assigning User Values to Variable
    $lid = $_REQUEST['lesson_id'];
    $teaId=$_REQUEST['tea_id'];
   ...
   $sql = "UPDATE lesson SET lesson_id = '$lid',tea_id = '$teaId', lesson_name = '$lname', lesson_desc = '$ldesc', course_id='$cid', course_name='$cname', lesson_link='$llink' WHERE lesson_id = '$lid'";
 ...
 ?>
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="tea_id" name="tea_id" value="<?php if(isset($row['tea_id'])) {echo $row['tea_id']; }?>" readonly>
    </div>
    <div class="form-group">
    ...
    <div class="text-center">
      ...
      <a href="lessons.php?course_id=<?php echo $_POST['course_id']; ?>" class="btn btn-secondary">Close</a>
    </div>
